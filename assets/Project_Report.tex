...
\textbf{\Large MCP-COORDINATED SWARM INTELLIGENCE: ADAPTIVE UAV PATH PLANNING FOR DYNAMIC DISASTER RESPONSE}\\[3pt]
...
\begin{figure}[h]
  \begin{center}
  \includegraphics[width=3.5cm, height=2cm]{logo2.jpg}
  \end{center}
\end{figure}
